...
{
  VsxStartTypingHandler *handler = object;
...
{
  VsxStartTypingHandler *self = (VsxStartTypingHandler *) handler;
  VsxPersonId id;
  ...
  if (klass.parent_class.free == NULL)
    {
      ...
      klass.parent_class.instance_size = sizeof (VsxStartTypingHandler);
