...
static void
vsx_netaddress_to_native_ipv4(const struct vsx_netaddress *address,
...
static void
vsx_netaddress_to_native_ipv6(const struct vsx_netaddress *address,
                         ...
                         struct vsx_netaddress_native *native)
{
        if (address->family == AF_INET6) {
                vsx_netaddress_to_native_ipv6(address, &native->sockaddr_in6);
                native->length = sizeof native->sockaddr_in6;
        } else {
                vsx_netaddress_to_native_ipv4(address, &native->sockaddr_in);
                native->length = sizeof native->sockaddr_in;
        }
}

static void
vsx_netaddress_from_native_ipv4(struct vsx_netaddress *address,
...
static void
vsx_netaddress_from_native_ipv6(struct vsx_netaddress *address,
                           ...
                           const struct vsx_netaddress_native *native)
{
        ...
        case AF_INET:
                vsx_netaddress_from_native_ipv4(address,
                                                &native->sockaddr_in);
                break;

        case AF_INET6:
                vsx_netaddress_from_native_ipv6(address,
                                                &native->sockaddr_in6);
                break;
...
vsx_netaddress_to_string(const struct vsx_netaddress *address)
{
        ...
        char *buf = vsx_alloc(buffer_length);
                           ...
                           int default_port)
{
        ...
        if (*str == '[') {
                ...
                vsx_buffer_append(&buffer, str + 1, addr_end - str - 1);
                vsx_buffer_append_c(&buffer, '\0');
                ...
                vsx_buffer_append(&buffer, str, addr_end - str);
                vsx_buffer_append_c(&buffer, '\0');
