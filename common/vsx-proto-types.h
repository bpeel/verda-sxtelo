...
VSX_PROTO_TYPE(VSX_PROTO_TYPE_UINT8, uint8_t, unsigned int)
VSX_PROTO_TYPE(VSX_PROTO_TYPE_UINT16, uint16_t, unsigned int)
VSX_PROTO_TYPE_SIMPLE(VSX_PROTO_TYPE_UINT32, uint32_t)
VSX_PROTO_TYPE_SIMPLE(VSX_PROTO_TYPE_UINT64, uint64_t)
VSX_PROTO_TYPE(VSX_PROTO_TYPE_INT16, int16_t, int)
